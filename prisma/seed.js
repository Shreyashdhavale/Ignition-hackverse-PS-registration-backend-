...
async function main() {
  const data = [
    ...
    { id: "PS0106", track: 1, psNumber: 6, title: "Smart Grid Management System" },
    ...
    { id: "PS0206", track: 2, psNumber: 6, title: "Personalized Treatment Recommendation" },
    ...
    { id: "PS0306", track: 3, psNumber: 6, title: "Virtual Classroom with AR/VR" },
    ...
    { id: "PS0406", track: 4, psNumber: 6, title: "Passwordless Authentication System" },
  ];
